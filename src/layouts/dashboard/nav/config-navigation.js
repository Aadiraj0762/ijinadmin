  ...
  // ----------------------------------------------------------------------
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: ICONS.file,
        children: [
          { title: 'Journal list', path: '/dashboard/abstractjournal/' },
          { title: 'Journal create', path: '/dashboard/abstractjournal/new' },
          { title: 'Conference list', path: '/dashboard/abstractconference/' },
